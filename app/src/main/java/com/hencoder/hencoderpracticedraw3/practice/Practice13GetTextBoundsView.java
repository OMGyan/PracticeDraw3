...
public class Practice13GetTextBoundsView extends View {
...

    {
        ...
        paint2.getTextBounds(texts[1],0,texts[1].length(),rect);
        yOffsets[1] = -(rect.top+rect.bottom)/2;
        paint2.getTextBounds(texts[2],0,texts[2].length(),rect);
        yOffsets[2] = -(rect.top+rect.bottom)/2;
        paint2.getTextBounds(texts[3],0,texts[3].length(),rect);
        yOffsets[3] = -(rect.top+rect.bottom)/2;
        paint2.getTextBounds(texts[4],0,texts[4].length(),rect);
        yOffsets[4] = -(rect.top+rect.bottom)/2;
        paint2.getTextBounds(texts[5],0,texts[5].length(),rect);
